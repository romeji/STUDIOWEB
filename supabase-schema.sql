...
create table if not exists public.briefs (
  ...
  answers jsonb not null default '{}'::jsonb, generated_prompt text not null default '', photo_paths jsonb not null default '[]'::jsonb,
...
create table if not exists public.clients (
  ...
  provider text not null default 'manual', provider_subscription_id text, started_at date, canceled_at timestamptz,
  created_at timestamptz not null default now()
);
