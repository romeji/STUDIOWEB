...
- La création du site par IA reste manuelle : générer le document HTML depuis le prompt, le coller dans la demande correspondante de `/admin`, puis cliquer sur Enregistrer. L’e-mail contenant le lien privé est envoyé automatiquement par Resend après enregistrement.
